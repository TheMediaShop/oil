...
| poi_hub_path | The path to the hub.html installation on the origin, if any. | `/@tashop/oil.js@{version}/release/current/hub.html`
...
| publicPath | The server path from which all chunks and resources will be loaded. You should upload all released files there and configure it. | `https://unpkg.com/@tashop/oil.js@{version}/release/current/`
