...
[![npm version](https://img.shields.io/npm/v/@tashop/oil.js.svg)](https://www.npmjs.com/package/@tashop/oil.js)
...
<script type="text/javascript" src="https://unpkg.com/@tashop/oil.js/release/current/oil.RELEASE.min.js"></script>
```
...
| poi_hub_path | The path to the hub.html installation on the origin, if any. | `/@tashop/oil.js@{oilVersion}/release/current/hub.html`
...
| publicPath | The server path from which all chunks and ressources will be loaded. You should upload all released files there and configure it. | `//unpkg.com/@tashop/oil.js@{oilVersion}/release/current/`
