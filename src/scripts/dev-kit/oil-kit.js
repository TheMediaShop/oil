...
export function loadOilJs() {
  ...
  if (!oldScript) {
    let config = {
      publicPath: '//unpkg.com/@tashop/oil.js/release/current/'
    };
  ...
  loadJS('oil-stub-js', '//unpkg.com/@tashop/oil.js/release/current/oilstub.min.js', () => {
    loadJS('oil-js', '//unpkg.com/@tashop/oil.js/release/current/oil.min.js', () => {
